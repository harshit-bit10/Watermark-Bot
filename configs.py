...
class Config(object):
	...
	OWNER_ID = int(os.environ.get("OWNER_ID", 7869658556))
	CAPTION = "By @AHToolsBot"
	BOT_USERNAME = os.environ.get("BOT_USERNAME", "WatermarkSetbot")
...
__Note: I can only process one video at a time. As my server is Heroku, my health is not good. If you have any issues with Adding Watermark to a Video, then please Report at [Support Group](https://t.me/SandVillage).__
