...
async def send_video_handler(bot, cmd, output_vid, video_thumbnail, duration, width, height, editable, logs_msg, file_size):
    ...
    sent_vid = await bot.send_video(
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/SupremeYoriichi")],
                                           [InlineKeyboardButton("Bots Channel", url="https://t.me/SharkToonsIndia")],
                                           [InlineKeyboardButton("Git-ID Support", url="https://github.com/harshit-bit10")]]),
